...
<html lang="en">
  ...
  <a href="reviewcontrol.php"><button class="dropdown-item" type="button" href="review.php">Reviews</button></a>
  <a href="storescontrol.php"><button class="dropdown-item" type="button">Stores</button></a>
  <a href="staffcontrol.php"><button class="dropdown-item" type="button">Staff</button></a> 
  <a href="inventorycontrol.php"><button class="dropdown-item" type="button">Inventory</button></a>
